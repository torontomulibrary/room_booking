...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <title>
    Room Booking | Ryerson University Library &amp; Archives  </title>
          ...
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <!-- RULA Logo standalone site compatability -->
                              <a class="navbar-brand" href="https://library.ryerson.ca/" ga-on="click" ga-event-category="Navigation" ga-event-action="Header click" ga-event-label="RULA Logo"><img src="<?php echo base_url(); ?>assets/template/rula2018/images/rula-logo.png" alt="Ryerson University Library &amp; Archives"></a>
                          </div>
...
<li id="menu-item-29134" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-29134"><a href="https://library.ryerson.ca/siteindex/" ga-on="click" ga-event-category="Navigation" ga-event-action="Footer click" ga-event-label="Site Index">Site Index</a></li>
      ...
      <div class="col-xs-12 col-sm-6">
            ...
            <img src="<?php echo base_url(); ?>assets/template/rula2018/images/rula_map.png" alt="Google Map" class="map">
          </a>
              </div>
    </div>
  </div>
